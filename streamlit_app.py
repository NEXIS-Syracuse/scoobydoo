...
clint = st.Page("Stardew_Characters/clint.py", title ="HW 5 - SU Org Memory Chatbot", icon=":material/description:", default=True)
maru = st.Page("Stardew_Characters/maru.py", title ="HW 5 - SU Org Memory Chatbot", icon=":material/description:", default=True)
haley = st.Page("Stardew_Characters/haley.py", title ="HW 5 - SU Org Memory Chatbot", icon=":material/description:", default=True)
